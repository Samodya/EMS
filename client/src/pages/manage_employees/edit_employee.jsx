...
export const Edit_Employee = () => {
  ...
  return (
    <div className="add_page_cont">
      <h2 className="poppins-bold">{fullname}'s Details</h2>
      <div className="edit_emp">
        <div class="poppins-bold userImg">
          <img src={previewSource ? previewSource : userImg} />
          <br />
          <input
            type="file"
            id="file-input"
          ...
          <label
            htmlFor="file-input"
            className=" poppins-semibold file-input_label"
          >
            <TbCameraPlus />
          </label>
          <button className="prof_img_save">Save</button>
        </div>
        <div class="item poppins-bold">
